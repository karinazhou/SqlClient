...
namespace Microsoft.Data.SqlClient.SNI
{
    ...
    internal class SNIProxy
    {
        ...
        public SNIHandle CreateConnectionHandle(object callbackObject, string fullServerName, bool ignoreSniOpenTimeout, long timerExpire, out byte[] instanceName, ref byte[] spnBuffer, bool flushCache, bool async, bool parallel, bool isIntegratedSecurity, string cachedFQDN, ref AzureSQLDNSInfo pendingDNSInfo)
        {
        ...
        private SNITCPHandle CreateTcpHandle(DataSource details, long timerExpire, object callbackObject, bool parallel, string cachedFQDN, ref AzureSQLDNSInfo pendingDNSInfo)
        {
            // TCP Format: 
